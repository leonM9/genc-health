...
export default function DoctorDashboard() {
  ...
  const uploadRecord = async () => {
    ...
    try {
      ...
      setFile(null); setDiagnosis(""); setNotes(""); load();
    } catch (e) {
      console.error(e);
  ...
  return (
    <Layout
      ...
      subtitle="Search patients by DID or wallet. Request history. Upload encrypted abstracts — every key wrapped under a CP-ABE policy."
    >
      <Tabs defaultValue="search">
        ...
        <TabsContent value="search">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {filtered.length === 0 && (
              <div className="lg:col-span-3 card-modern p-12 text-center text-zinc-500 font-mono text-sm">
            ...
            {filtered.map((p) => {
              ...
              return (
                <motion.div
                  key={p.address}
                  className="card-modern p-5 hover:border-emerald-400/40 transition"
                  whileHover={{ y: -3 }}
                ...
                >
                  ...
                  <div className="mt-4 flex gap-2">
                    <button
                      ...
                      className="flex-1 btn-ghost-modern h-9 px-3 text-[11px] font-semibold"
                    >Select</button>
                    {!grant && (
                      <button
                        onClick={() => sendRequest(p)}
                        data-testid={`req-${p.address.toLowerCase()}-btn`}
                        className="flex-1 btn-primary-modern h-9 px-3 text-[11px] font-semibold"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
            <div className="card-modern p-6 lg:col-span-2">
              ...
              <div className="space-y-4">
                ...
                <button
                  data-testid="submit-record-btn" onClick={uploadRecord}
                ...
                <AnimatePresence>
                  ...
                  {pipeline.map((s, i) => {
                    ...
                    const tone = s.status === "active" ? "border-amber/40 bg-amber/5"
                      ...
                      : s.status === "error" ? "border-rose/40 bg-rose/5"
                      : "border-white/5";
